...
//  2019-02-11: OpenGL: Projecting clipping rectangles correctly using draw_data->FramebufferScale to allow multi-viewports for retina ui.
...
void    ImGui_ImplOpenGL3_RenderDrawData(ImDrawData* draw_data)
{
    ...
    ImVec2 clip_scale = draw_data->FramebufferScale; // (1,1) unless using retina ui which are often (2,2)
