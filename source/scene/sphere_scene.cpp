...
std::optional<cr::intersection> cr::sphere_scene::intersect(const cr::ray &ray) {
//	static auto diffuse = std::make_unique<cr::diffuse>(glm::vec3(0.0f), glm::vec3(1.0f, 1.0f, 1.0f));
...
//						.normal = glm::normalize(point - origin)
//		};
		return {};
