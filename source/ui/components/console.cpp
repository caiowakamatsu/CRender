...
cr::component::console::Options cr::component::console::Component::display(DisplayContents contents) const {
	ImGui::Begin("Console");
	...
	for (const auto &string : *contents.lines) lines_to_display.push_back(string);
